...
if("TRUE" STREQUAL "TRUE")
  set(myworkcell_core_SOURCE_PREFIX /home/vtl/industrial_ws/src/myworkcell_core)
  set(myworkcell_core_DEVEL_PREFIX /home/vtl/industrial_ws/devel)
  ...
  set(myworkcell_core_INSTALL_PREFIX /home/vtl/industrial_ws/install)
...
if(NOT "/home/vtl/industrial_ws/devel/include " STREQUAL " ")
  set(myworkcell_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/vtl/industrial_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'vtl <vtl@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vtl/industrial_ws/src/myworkcell_core/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;fake_ar_publisher;message_runtime;geometry_msgs;tf2_ros;tf2_geometry_msgs")
