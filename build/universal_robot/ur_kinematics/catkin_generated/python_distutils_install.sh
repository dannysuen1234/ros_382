...
echo_and_run cd "/home/vtl/industrial_ws/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/vtl/industrial_ws/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/vtl/industrial_ws/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
